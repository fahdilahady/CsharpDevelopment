...
namespace AwsClasses.Tools
{
    public class GSM_modem : Tools
    {
        ...
        public GSM_modem(string portName, int baudRate = 9600, Parity parity = Parity.None, int dataBits = 8, StopBits stopBits = StopBits.One, Cpu.Pin Power = Pins.GPIO_PIN_D9, Cpu.Pin Reset = Pins.GPIO_PIN_D8)
        {
