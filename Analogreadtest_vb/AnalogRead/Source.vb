...
Namespace AnalogTest
	Public Class Program
		Private Const MaximumValue_int As Integer = 1024
		Private Const AnalogReference_float As Single = 3.3F
		Private Const VoltsPerCount_float As Single = AnalogReference_float / MaximumValue_int
		...
		Public Shared Sub Main()
			...
			While True
				...
				ADC_analogValueConverted_float = CSng(ADC_digitalValueRead_int) * VoltsPerCount_float
				...
				ADC_digitalValueReadAverage_int = ADC_digitalValueReadSum_int >> 2
				' ADC_digitalValueReadSum_int = (ADC_digitalValueReadSum_int/4);
				' convert digital value to analog voltage
				ADC_analogValueAverageConverted_float = CSng(ADC_digitalValueReadAverage_int) * VoltsPerCount_float
				' Print the values in the debug window
